...
namespace VMS.TPS
{
    ...
    ///      Lightweight (~1 MB). Copy to ESAPI_EQD2Viewer.Tests\TestFixtures\.
    ///
    ...
    public class Script
    {
        ...
        public void Execute(ScriptContext context)
        {
            ...
            var choice = MessageBox.Show(
                ...
                "            Kopioi ESAPI_EQD2Viewer.Tests\\TestFixtures\\\n\n" +
                "[Peruuta] → Keskeytä",
      ...
      string planId   = context.ExternalPlanSetup?.Id ?? "NOPLAN";
       ...
       string outputDir = ESAPI_EQD2Viewer.FixtureGenerator.SnapshotExporter
  ...
  // this guarantees the snapshot is byte-for-byte equivalent to what the app sees.
      ...
      var snapshot   = dataSource.LoadSnapshot();
            ...
            var exporter = new ESAPI_EQD2Viewer.FixtureGenerator.SnapshotExporter();
